...
$date_limite_inscription = date_create('2023-11-09');
$aujourdhui = new DateTime("now");
$dateconcours = new DateTime('2023-11-09 14:00:00');
$datefinconcours = new DateTime('2023-11-09 20:00:00');
        ...
        if ($req = $conn->prepare("SELECT score FROM teams WHERE id=?")) { // requête préparée
            ...
            if ($score < $score_ancien) { // si le score est meilleur
                if ($req3 = $conn->prepare("UPDATE teams SET score =? WHERE id=?")) {
                    ...
                    $datefreeze = new DateTime('2023-11-09 19:30:00');
                    if ($date<=$datefreeze) {
