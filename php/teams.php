  ...
  <div class="content">
    <div class="container">
      ...
      <table  border="4">
          ...
          <tbody>
              <tr>
                <?php if (is_admin()) { echo '<td>'.htmlspecialchars($team_affiche->id).'</td>'; } ?>
                  ...
                  <td><?php if ($team_affiche->hub==1){ echo "Hub de l'École des Ponts"; } else { echo "Hub du Plateau Saclay"; } ?></td>
      ...
      <table  border="4">
          ...
          <tbody>
              <tr>
                  ...
                  <?php if (is_admin()) { echo '<td>'.htmlspecialchars($membre_1->tel).'</td>'; } ?>
                  <?php if (is_admin()) { echo '<td>'.htmlspecialchars($membre_1->mail).'</td>'; } ?>
                  <?php if (is_admin()) { echo '<td><a href="edit_info_admin.php?id='.htmlspecialchars($membre_1->id).'">'.htmlspecialchars($membre_1->id).'</a></td>'; } ?>
              </tr>
              <tr>
                  ...
                  <?php if (is_admin()) { echo '<td>'.htmlspecialchars($membre_2->tel).'</td>'; } ?>
                  <?php if (is_admin()) { echo '<td>'.htmlspecialchars($membre_2->mail).'</td>'; } ?>
                  <?php  if (is_admin()) { echo '<td><a href="edit_info_admin.php?id='.htmlspecialchars($membre_2->id).'">'.htmlspecialchars($membre_2->id).'</a></td>'; } ?>
              </tr>
              <tr>
                  ...
                  <?php if (is_admin()) { echo '<td>'.htmlspecialchars($membre_3->tel).'</td>'; } ?>
                  <?php if (is_admin()) { echo '<td>'.htmlspecialchars($membre_3->mail).'</td>'; } ?>
                  <?php if (is_admin()) { echo '<td><a href="edit_info_admin.php?id='.htmlspecialchars($membre_3->id).'">'.htmlspecialchars($membre_3->id).'</a></td>'; } ?>
              </tr>
          </tbody>
      </table>
    </div>
