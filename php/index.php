    ...
    <section class="page-section bg-light" id="partenaires">
        <div class="container">
            <div class="text-center" style=" border-radius: 10px; padding:1rem; background-color: rgba(73, 73, 73, 0.356);">
                ...
                <span class="text-white" style="font-size: 1.7em;">Sponsorisée par PELICO, la Fondation des Ponts et le CERMICS</span>
            </div>
                <div class="row h-100">
                    <div class="col-lg-12" style="margin-top: 2rem;">
                        <div class="box">
                            ...
                            résultats prévisibles en anticipant les blocages de production et en agissant rapidement pour les résoudre.</p>
                        </div>
                    </div>
                </div>
                <div class="row h-100">
