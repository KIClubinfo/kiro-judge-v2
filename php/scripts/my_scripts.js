...
function avance(aMasquer, aAfficher){
  ...
  if (aMasquer === "participant-1"){ //Pour passer du 1 au 2, que si tout est valide
    if (document.getElementById("prenom-1").validity.valid && document.getElementById("nom-1").validity.valid && document.getElementById("email-1").validity.valid && document.getElementById("tel-1").validity.valid){ //si tous les champs sont ok on envoie la suite
    ...
    if (document.getElementById("prenom-2").validity.valid && document.getElementById("nom-2").validity.valid && document.getElementById("email-2").validity.valid && document.getElementById("tel-2").validity.valid){ //si tous les champs sont ok on envoie la suite
      ancien.style.display = "none";
      nouveau.style.display = "block";
    }
  }
